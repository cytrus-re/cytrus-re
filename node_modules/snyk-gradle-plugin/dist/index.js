...
async function getInjectedScriptPath(isGradle3Plus) {
...
async function getAllDeps(root, targetFile, options) {
    ...
    if (versionBuildInfo && versionBuildInfo.gradleVersion) {
        ...
        isGradle3Plus = +((_a = versionBuildInfo.gradleVersion) === null || _a === void 0 ? void 0 : _a.substring(0, 1)) >= 3;
    }
    const { injectedScripPath, cleanupCallback } = await getInjectedScriptPath(isGradle3Plus);
