  ...
  try {
    if (message.guild) {
      message.channel.send(
        "For security reasons, this command is not available in servers. Please run this command in DM's."
      );
    ...
    let embed = new client.Embed("normal", {
      ...
      fields: [
        ...
        },
        {
          ...
          text:
            res.crack_times_display.online_throttling_100_per_hour.toProperCase() ||
            "Not Available",
        },
        {
          title: "Unthrottled Online Attack Crack Time",
          text:
            res.crack_times_display.online_no_throttling_10_per_second.toProperCase() ||
            "Not Available",
        },
        {
          title: "Offline attack, Slow hash, Many cores Crack Time",
          text:
            res.crack_times_display.offline_slow_hashing_1e4_per_second.toProperCase() ||
            "Not Available",
        },
        {
          title: "Offline attack, Fast hash, Many cores Crack Time",
          text:
            res.crack_times_display.offline_fast_hashing_1e10_per_second.toProperCase() ||
            "Not Available",
        },
      ],
    });
...
exports.help = {
  ...
  category: "General",
  description:
    "Returns how long your password will take to crack and the strength score of it. DM only.",
