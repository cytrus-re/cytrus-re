exports.run = async (client, message, args) => {
  try {
    ...
    if (user === message.author)
      return message.channel.send(client.errors.cannotBanSelf);
    if (user) {
        ...
        member
          ...
          .then(() => {
            ...
            if (
              ...
              // Checks if the modlog is enabled and the channel specified for it exists.
