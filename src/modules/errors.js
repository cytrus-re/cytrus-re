const errors = {
  "genericError": "There was an error!\nPlease send the following to a Cytrus-RE dev (Odyssey346#9848 or Rexowogamer#1183) and tell them command you used (including arguments).\n---------------------------------------------------------------------------------------------------------------------\n",
  ...
  "cannotSayEveryone": "Sorry, you cannot mention everyone or here with say, for obvious reasons. (If it isn't obvious, we don't want chaos)"
};
