const errors = {
  ...
  cannotBanSelf:
    "❌ Sorry, you can't ban yourself. (It would be funny, if it weren't so sad.)",
  cannotKickSelf:
    "❌ Sorry, you can't kick yourself. (If you don't want to be here, just leave.)",
  ...
  noArticleDescription:
    "❌ This article doesn't have a description or something went wrong.",
  cannotPingEveryone:
    "❌ Sorry, you cannot mention everyone or here with say, for obvious reasons. (If it isn't obvious, we don't want chaos.)",
  mathError:
    "❌ Sorry, you did something wrong with your maths.\n---------------------------------------------------------------------------------------------------------------------\n",
  sendfileError:
    "❌ Either that file doesn't exist or something went wrong.\n---------------------------------------------------------------------------------------------------------------------\n",
};
