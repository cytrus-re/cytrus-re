module.exports = async (client) => {
  const statusList = [
    {
      msg: `Cytrus-RE ${client.config.version}| ${client.config.defaultSettings.prefix}help | Check out our ${client.config.defaultSettings.prefix}site!`,
      type: "PLAYING",
    },
    {
    ...
    {
      msg: `people try out ${client.config.version}! (${client.config.defaultSettings.prefix}changelog) | ${client.config.defaultSettings.prefix}help | Check out our ${client.config.defaultSettings.prefix}site!`,
      type: "WATCHING",
    },
    ...
    {
      msg: `over ${client.guilds.cache.size} servers | ${client.config.defaultSettings.prefix}help | Check out our ${client.config.defaultSettings.prefix}site!`,
      type: "WATCHING",
    },
    {
      msg: `development progress! | ${client.config.defaultSettings.prefix}help | Check out our ${client.config.defaultSettings.prefix}site!`,
      type: "WATCHING",
    },
  ...
  client.logger.info(
    `...and using Discord.js v${require("discord.js").version.replace(
      " ",
      ""
    )}`,
    "ready"
  ...
  client.logger.info(
    "Cytrus-RE V" +
      ...
      " | https://github.com/Cytrus-RE/cytrus-re"
  );
  client.startuptime = new Date().getTime() - client.starttime;
  client.logger.info(
    "It took " + client.startuptime + "ms to start Cytrus-RE."
  );
};
